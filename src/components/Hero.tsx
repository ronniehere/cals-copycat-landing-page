...
const Hero = () => {
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-background to-secondary/10 pt-16">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-lg font-inter">
                Smart calorie tracking powered by AI. Simply snap a photo of your meal and let Cals do the rest. Reach your health goals faster than ever.
              </p>
            </div>
